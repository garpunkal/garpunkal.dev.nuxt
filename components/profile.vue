			...
			<div class="p-4 md:p-12">
				...
				<div class="flex flex-col w-full items-center lg:items-start">
					...
					<div class="flex flex-col gap-1 w-full text-gray-600 dark:text-gray-300 text-sm lg:text-sm">
						...
						/>
						<Bullet
							title="Umbraco CMS Expert, Contributor and Package Developer"
						...
						/>
						<Bullet title="Azure Cloud and DevOps Developer" svgPath="M5.483 21.3H24L14.025 4.013l-3.038 8.347 5.836 6.938L5.483 21.3zM13.23 2.7L6.105 8.677 0 19.253h5.505v.014L13.23 2.7z" />
						<Bullet
